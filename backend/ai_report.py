...
FIELD_VALUE_LABELS = {
    ...
    "six_daowei_facts_confirmed": {True: "已核对交付模式与关键角色"},
    ...
    "six_daowei_operations_autonomy": {
        "in_place": "到位", "not_in_place": "不到位", "pending_evidence": "待补证据",
        "not_applicable": "不适用（无运维/售后义务）",
    },
    "six_daowei_level": {"strong": "强", "medium": "中", "none": "无"},
    "service_period": {
        "lte_3m": "≤3个月",
        "3m_12m": "3-12个月",
        "gt_12m": ">12个月",
